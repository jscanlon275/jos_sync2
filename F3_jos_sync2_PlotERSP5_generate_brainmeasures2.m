...
%% Figure showing individual values (for reviewer) 
...
histogram(tmp6, 15);
xlim([-1 2]);
title('Alpha-mu LEFT cluster distribution of subject values');
ylabel('number of subs (out of 18)');
xlabel('alpha power averaged over the walking cycle');
legend({'natural', 'control', 'sync'});
CONDS_lr = {'id','a_natural_right', 'b_control_right', 'c_sync_right','d_natural_left', 'e_control_left', 'f_sync_left'};
...
histogram(tmp2, 15)
histogram(tmp3, 15)
title('Alpha-mu RIGHT cluster distribution of subject values');
ylabel('number of subs (out of 18)');
xlabel('alpha power averaged over the walking cycle');
legend({'natural', 'control', 'sync'});
xlim([-1 2])
...
histogram(tmp2, 15)
histogram(tmp3, 15)
title('Beta Central cluster distribution of subject values');
ylabel('number of subs (out of 18)');
xlabel('beta power averaged over the walking cycle');
legend({'natural', 'control', 'sync'});
xlim([-1 2])